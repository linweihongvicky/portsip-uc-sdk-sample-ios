...
/*!
 *  @brief When the camera does not support specified resolution,
 *         enable or disable SDK to crop and scale to the specified resolution.
 *
 *  @param enable Enable or disable to Video crop or scale the video to fit in specified resolution.
...
/*!
 *  @brief Set the window on which the local video image will be displayed.
 *
 ...
 *  @return If the function succeeds, it will return value 0. If the function fails, it will return a specific error code.
 */
- (int)displayLocalVideo:(BOOL) state mirror:(BOOL)mirror;
 ...
 *  @return If the function succeeds, it will return value 0. If the function fails, it will return a specific error code.
 *  @remark
 Please read the sample project source code for more details, or you can watch the video on YouTube at https://www.youtube.com/watch?v=_2w9EGgr3FY, 
 ...
 *  @return If the function succeeds, it will return value 0. If the function fails, it will return a specific error code.
 *  @remark
 Please refer to the sample project source code for more details. Or you can watch the video on YouTube at https://www.youtube.com/watch?v=_2w9EGgr3FY.
 It will demonstrate the transmission.
 */
 ...
 * <tr><td>AUDIOSTREAM_BOTH</td><td>Callback both local and remote audio stream on the given sessionId. </td></tr>
 * </table></p>
 *
 *  @return If the function succeeds, it will return value 0. If the function fails, it will return a specific error code.
 ...
 *  @param audioFileFormat  The file format for the audio recording.
 *  @param audioRecordMode  The audio recording mode.
 *  @param aviFileCodecType The codec that is used for compressing the video data to save into video recording.
 ...
 *
 *  @param sessionId Session ID of the call.
 *  @param aviFile   The full filepath, such as "/test.avi".
 *  @param loop      Set to false to stop playing video file when it is ended, or true to play it repeatedly.
 *  @param playAudio If it is set to true, audio and video will be played together, or false with video played only.
 *
 *  @return If the function succeeds, it will return value 0. If the function fails, it will return a specific error code.
 */
...
/*!
 *  @brief Stop playing video file to remote party.
 *
 *  @param sessionId Session ID of the call.
 *
 *  @return If the function succeeds, it will return value 0. If the function fails, it will return a specific error code.
 ...
 *
 *  @param sessionId         Session ID of the call.
 *  @param filename          The full filepath, such as "/test.wav".
 *  @param fileSamplesPerSec The sample wave file in seconds. It should be 8000, 16000 or 32000.
...
- (int)playAudioFileToRemote:(long)sessionId
                    filename:(NSString*) filename // Support .wav, .amr and .pcm formats
           fileSamplesPerSec:(int) fileSamplesPerSec // fileSamplesPerSec MUST be sent for playing .pcm file
                        loop:(BOOL)loop;

/*!
 *  @brief Stop playing wave file to remote party.
 *
 *  @param sessionId Session ID of the call.
 *
 *  @return If the function succeeds, it will return value 0. If the function fails, it will return a specific error code.
...
/*!
 *  @brief Stop playing a wave file to remote party as conversation background sound.
 *
 *  @param sessionId Session ID of the call.
 *
 *  @return If the function succeeds, it will return value 0. If the function fails, it will return a specific error code.
 ...
 *  @param displayLocalVideoInConference Display the local video on video window.
 *
 *  @return If the function succeeds, it will return value 0. If the function fails, it will return a specific error code.
 */
...
/*!
 *  @brief Obtain the statistics of video channel.
 *
 *  @param sessionId          The session ID of call conversation.
 *  @param sendBytes          The number of sent bytes.
 *  @param sendPackets        The number of sent packets.
